...
const versions: DropdownOption[] = [
    { value: 'latest', label: 'v1.0.12 (latest)' },
    { value: '1.0.11', label: 'v1.0.11', disabled: true, disabledReason: "Documentation for this version is not available." },
    { value: '1.0.10', label: 'v1.0.10', disabled: true, disabledReason: "Documentation for this version is not available." },
    { value: '0.9.0', label: 'v0.9.0', disabled: true, disabledReason: "Documentation for this version is not available." },
];
